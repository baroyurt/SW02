<?php
/**
 * Port Change Alarms Page
 * Real-time monitoring of MAC movements, VLAN changes, and port configuration updates
 */
...
<head>
    ...
    <title><?php echo $pageTitle; ?> - Switch Management</title>
